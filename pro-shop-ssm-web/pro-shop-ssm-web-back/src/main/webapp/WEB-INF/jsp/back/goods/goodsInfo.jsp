...
<article class="page-container">
    <form action="${rootPath}/back/goods/cateUpdate.mvc" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                    <fmt:formatDate value="${one.pubTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
            </div>
        </div>
        <div class="row cl">
