...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="member_del()"
               class="btn btn-danger radius">
                <i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
            <a
                href="javascript:;" onclick="member_add('添加用户','${rootPath}/back/users/usersInsert.mvc','','510')"
                          ...
                          <%--  <td>${stat.count}</td>--%>
                            ...
                            <td>
                                <u style="cursor:pointer" class="text-primary"
                                   onclick="member_show('查看分类','${rootPath}/back/users/usersUpdate.mvc?id=${listTemp.id}','','','510')">
                                    <%--${listTemp.name}--%>
                                    ${listTemp.username}
                                </u>
                            </td>
...
<%--                                </a>--%>
                                <a
                                    title="编辑" href="javascript:;" onclick="member_edit('编辑','${rootPath}/back/users/usersUpdate.mvc?id=${listTemp.id}&operType=update','4','','510')"
...
<%--                                </a>--%>
            ...
            <form id="pageForm" action="${rootPath}/back/users/usersList.mvc" method="post">
                <!-- 搜索条件 -->
