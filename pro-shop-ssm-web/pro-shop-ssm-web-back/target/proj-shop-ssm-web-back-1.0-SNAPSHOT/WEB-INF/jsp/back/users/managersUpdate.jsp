...
<head>
    ...
    <title>管理员更新 - 商城</title>
    <meta name="keywords" content="H-ui.admin v3.1,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
    <meta name="description" content="H-ui.admin v3.1，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
<article class="page-container">
    <form action="${rootPath}/back/users/managersUpdateSubmit.mvc" method="post" class="form form-horizontal" id="form-member-add">
...
<%--                    <c:forEach items = "${requestScope.managersList}" var="listTemp" varStatus="stat">--%>
<%--                        <option value="${listTemp.id}" ${one.managersId == listTemp.id ? 'select' :''}>${listTemp.username}--->${one.managersId}</option>--%>
<%--                    </c:forEach>--%>
...
<%--        </div>--%>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${one.password}" placeholder="" id="password" name="password">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>电话：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${one.phone}" placeholder="" id="phone" name="phone">
            </div>
        </div>
        <div class="row cl">
