...
<div class="page-container">
        ...
        <div class="text-c">
            ...
            <span class="select-box inline">
                ...
                <select name="cateId" class="select">
                    ...
                    <c:forEach items="${requestScope.cateId}" var="listTemp" varStatus="stat">
                        <option value="${listTemp.id}"${requestScope.cateId == listTemp.id ? 'selected' : ''}>${listTemp.name}</option>
                    </c:forEach>
                </select>
                状态:
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a
                href="javascript:;" onclick="member_add('添加商品','${rootPath}/back/goods/goodsInsert.mvc','','510')"
                ...
                <tbody>
                    <c:forEach items="${requestScope.list}" var="listTemp" varStatus="stat">
                        <tr class="text-c">
                            ...
                            <td>${stat.count}</td>
                            <td>${listTemp.id}</td>
                            <td>${listTemp.cate.name}</td>
                            <td>
                                <u style="cursor:pointer" class="text-primary"
                                   onclick="member_show('查看商品','${rootPath}/back/goods/goodsUpdate.mvc?id=${listTemp.id}','','','510')">
                                    ${listTemp.name}
                                </u>
                            </td>
                            <td>${listTemp.price}</td>
                            <td>${listTemp.saleNum}</td>
                            <td>${listTemp.stockNum}</td>
                            <td class="td-status">
...
<%--                                </a>--%>
                                <a
                                    title="编辑" href="javascript:;" onclick="member_edit('编辑','${rootPath}/back/goods/goodsUpdate.mvc?id=${listTemp.id}&operType=update','4','','510')"
...
<%--                                </a>--%>
            ...
            <form id="pageForm" action="${rootPath}/back/goods/goodsList.mvc" method="post">
                <!-- 搜索条件 -->
